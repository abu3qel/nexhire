...
export function BaselineComparison({ candidates }: Props) {
  ...
  if (completed.length === 0) {
    return <div className="text-center py-12 text-gray-400 text-sm">No completed assessments to compare</div>;
  }
            ...
            >
              ...
              <div className="flex items-center gap-5 text-sm">
                <div className="text-center">
                  ...
                  <div className="font-mono font-bold text-gray-700">#{c.baseline_rank}</div>
                </div>
                <div className="text-gray-300">→</div>
                <div className="text-center">
                  <div className="text-xs text-gray-500 mb-0.5">Multi-modal</div>
                  <div className={`font-mono font-bold ${improved ? "text-emerald-600" : dropped ? "text-amber-600" : "text-gray-700"}`}>
                    #{c.rank}
                  </div>
                </div>
                <div className="text-center min-w-[40px]">
                  <div className="text-xs text-gray-500 mb-0.5">Change</div>
                  <div className={`font-mono font-bold text-sm ${improved ? "text-emerald-600" : dropped ? "text-amber-600" : "text-gray-400"}`}>
                    {changed != null
