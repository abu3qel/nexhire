  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-slate-500 text-sm mt-0.5">{apps.length} application{apps.length !== 1 ? "s" : ""} submitted</p>
      </div>
      ...
      {apps.length > 0 && (
        <div className="rounded-xl bg-white border border-slate-200 shadow-sm overflow-hidden">
          <div className="grid grid-cols-[1fr_auto] bg-slate-50 border-b border-slate-200 px-5 py-3">
          ...
          {apps.map((app, i) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <div className="text-sm font-medium text-slate-900">Job ID: {app.job_id.slice(0, 8)}…</div>
